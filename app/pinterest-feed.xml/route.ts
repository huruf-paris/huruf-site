...
// Flux produit pour Pinterest Catalogs (même format RSS 2.0 + namespace g:
// que Google Shopping, que Pinterest accepte nativement).
// URL déjà enregistrée côté Pinterest, inchangée : https://www.huruf-paris.fr/pinterest-feed.xml
// Généré depuis data/products.ts (comme merchant-feed.xml) au lieu d'un fichier
// statique à maintenir à la main : il ne peut plus se désynchroniser du catalogue.
